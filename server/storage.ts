...
export interface IStorage {
  ...
  getIssuesByReporter(reportedBy: number): Promise<Issue[]>;
  getIssuesByAssignee(assignedTo: number): Promise<Issue[]>;
  getIssuesByWarehouse(warehouseId: number): Promise<Issue[]>;
