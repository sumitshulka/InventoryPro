  ...
  const saveMutation = useMutation({
    mutationFn: async (data: OrderFormValues) => {
      ...
      const payload = {
        ...
        shippingAddress: data.shippingAddressLine || "",
        shippingCity: data.shippingCity || "",
        shippingState: data.shippingState || "",
        shippingZipCode: selectedClient?.shippingZipCode || "",
        shippingCountry: data.shippingCountry || "India",
        billingAddress: selectedClient?.billingAddress || data.shippingAddressLine || "",
        billingCity: selectedClient?.billingCity || data.shippingCity || "",
        billingState: selectedClient?.billingState || data.shippingState || "",
        billingZipCode: selectedClient?.billingZipCode || "",
        billingCountry: selectedClient?.billingCountry || data.shippingCountry || "India",
        notes: data.notes,
