...
export const inventory = pgTable("inventory", {
	...
	unique("inventory_item_id_warehouse_id_unique").on(table.warehouseId, table.itemId),
...
export const locations = pgTable("locations", {
	...
	index("locations_updated_at_idx").using("btree", table.updatedAt.asc().nullsLast().op("timestamp_ops")),
...
export const rejectedGoods = pgTable("rejected_goods", {
	...
	check("rejected_goods_updated_at_not_null", sql`NOT NULL updated_at`),
]);
...
export const warehouseOperators = pgTable("warehouse_operators", {
	...
	unique("warehouse_operators_user_id_warehouse_id_unique").on(table.warehouseId, table.userId),
